...
ActiveRecord::Schema.define(version: 20_161_111_193_346) do
  ...
  create_table 'item_transitions', force: :cascade do |t|
    ...
    t.index %w(sort_key item_id), name: 'index_item_transitions_on_sort_key_and_item_id', unique: true, using: :btree
  end
