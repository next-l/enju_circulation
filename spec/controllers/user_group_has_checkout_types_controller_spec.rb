  ...
  describe 'GET index' do
    describe 'When logged in as Administrator' do
      ...
      it 'assigns all user_group_has_checkout_types as @user_group_has_checkout_types' do
        get :index
        assigns(:user_group_has_checkout_types).should eq(UserGroupHasCheckoutType.includes(%i[user_group checkout_type]).order('user_groups.position, checkout_types.position').page(1))
      end
    end
